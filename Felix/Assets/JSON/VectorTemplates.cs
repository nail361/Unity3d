...
public static partial class JSONTemplates {
	...
	public static AnimationCurve ToAnimationCurve(EDITOR.JSONObject obj){
		AnimationCurve a = new AnimationCurve();
		if(obj.HasField("keys")){
            EDITOR.JSONObject keys = obj.GetField("keys");
	...
	public static Keyframe ToKeyframe(EDITOR.JSONObject obj){
