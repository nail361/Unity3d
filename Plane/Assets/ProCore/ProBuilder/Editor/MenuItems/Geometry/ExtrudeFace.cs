...
namespace ProBuilder2.Actions
{
	public class ExtrudeFace : Editor
	{
		...
		{
			SelectMode mode = pb_Editor.instance.selectionMode;
			...
			foreach(pb_Object pb in pbs)
			{
				switch(mode)
				{
					...
					case SelectMode.Edge:
						...
						pb_Edge[] newEdges;
						bool success = pb.Extrude(pb.SelectedEdges, dist, pb_Preferences_Internal.GetBool(pb_Constant.pbManifoldEdgeExtrusion), out newEdges);
